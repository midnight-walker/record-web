...
class ScxcSupervisorEditModal extends Component {
    ...
    render() {
        ...
        const { name, regionId,stationId,village,group,smallClass,placeName,smallClassArea,treeCompose,targetName,time,workGroup,fcXianyan,fcXixiao,fcGaodudayuwu,fcChanzhe,fcFugai,fcFengzhe,fcHuoshao,fcXuanya,fcXuangua,fcHuoshukuzhi,fcTotal,jcFcFengzhe,jcFcSongshu,jcFcSongmu,jcFcSongzhi,jcFcShaotou,jcFcTotal,jcYcCaogai,jcYcKuye,jcYcTurang,jcYcTengman,jcYcDigou,jcYcDongxue,jcYcTotal,fsSongzhi,fsSongmu,fsSongcai,fzFazhuang,fzBopi,fzJiahao,fzTouyao,fzShuliao,fzNitu,fzTotal,fzNumber,longitude,latitude,picture,operator } = this.props.record;
        ...
        >
            <Form layout="horizontal" onSubmit={this.okHandler}>
                ...
                >
                    {
                        getFieldDecorator('jcFcSongshu', {
                            initialValue: jcFcSongshu,
                            rules:[{
                                required: true, message: '请填写松树',
                            }]
                        })(<Input />)
                    }
                </FormItem>
                ...
                >
                    {
                        getFieldDecorator('jcFcSongmu', {
                            initialValue: jcFcSongmu,
                            rules:[{
                                required: true, message: '请填写松木段',
                            }]
                        })(<Input />)
                    }
                </FormItem>
                ...
                >
                    {
                        getFieldDecorator('jcFcSongzhi', {
                            initialValue: jcFcSongzhi,
                            rules:[{
                                required: true, message: '请填写地上粗1厘米以上松枝',
                            }]
                        })(<Input />)
                    }
                </FormItem>
                ...
                >
                    {
                        getFieldDecorator('jcFcShaotou', {
                            initialValue: jcFcShaotou,
                            rules:[{
                                required: true, message: '请填写松树梢头',
                            }]
                        })(<Input />)
                    }
                </FormItem>
                ...
                >
                    {
                        getFieldDecorator('fsSongzhi', {
                            initialValue: fsSongzhi,
                            rules:[{
                                required: true, message: '请填写未完全炭化的松枝',
                            }]
                        })(<Input />)
                    }
                </FormItem>
                ...
                >
                    {
                        getFieldDecorator('fsSongmu', {
                            initialValue: fsSongmu,
                            rules:[{
                                required: true, message: '请填写未完全炭化的松木',
                            }]
                        })(<Input />)
                    }
                </FormItem>
                ...
                >
                    {
                        getFieldDecorator('fsSongcai', {
                            initialValue: fsSongcai,
                            rules:[{
                                required: true, message: '请填写未点火的松材堆',
                            }]
                        })(<Input />)
                    }
                </FormItem>
